...
|------------+------------------------------------------------------------------------------------------+-----------------------------------------------|
| =search=   | =vault=, =query=, =k=, =perFile=, =mode= (=semantic= or =lexical=), =model=, =any= | ={"hits": [...]}=                             |
...
Send it with =index=, not with every =search=: the policy is sticky and a change
is refused, so a mismatch is a question worth putting to the user --- /your
=org-todo-keywords= changed, reindex to match?/ --- rather than a silent rebuild
