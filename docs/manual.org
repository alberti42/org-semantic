...
rarely what a watcher's callback wants. It does nothing while the mode is off,
and is as cheap to over-call as a save: fifty touches inside the debounce are one
run.
