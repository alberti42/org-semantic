...
reproducible --- [[#somebody-elses-notes][Trying it on somebody else's notes]]
has two more of them. The question is in English, the note that answers it is in
Italian, and its title --- /Sistemi Operativi/ --- shares no word with the
question. Finding what you can describe but cannot name is the whole point of
org-semantic; with a multilingual model it stops mattering which language you
could not name it in. An English note is ranked beside the Italian ones, in the
one list.
