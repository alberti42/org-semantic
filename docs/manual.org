...
|------------+------------------------------------------------------------------------------------------+-----------------------------------------------|
| =search=   | =vault=, =query=, =k=, =perFile=, =mergeSections=, =mode= (=semantic= or =lexical=), =model=, =any=, =config= | ={"hits": [...]}= |
...
If you would rather see one result per section, =--merge-sections= (=mergeSections=
