...
search again by itself; =q= or =C-g= leaves it, and =g= in the results buffer
searches again to be asked afresh. =M-x org-semantic-show-status= says the same
thing before you ask: a model it lists as not cached is one that would refuse.
