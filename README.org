...
#+language: en
#+description: Semantic and lexical search for a large collection of org-mode notes. One static binary, no server, no database, no Python.
...
(Apache-2.0) over [[https://github.com/pykeio/ort][ort]] (Apache-2.0).
